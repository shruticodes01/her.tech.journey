...
// Array of books -- each book is represented by an Object
const books = [
  {
    title: 'Algorithms',
...
// console.log(title, author, ISBN); // Algorithms Array [ "Robert Sedgewick", "Kevin Wayne" ] 9780321573513
...
// console.log(tags); // Array(8) [ "computer science", "programming", "algorithms", "data structures", "java", "math", "software", "engineering" ]
...
// console.log(bookTitle, bookAuthor); // Algorithms Array [ "Robert Sedgewick", "Kevin Wayne" ]
...
// spellWord(word); // J a v a S c r i p t
